namespace Web.Asp.Provider
{
    ...
    public class Constant
    {
        ...
        public string LoginPage = "/Login.aspx";
        ...
        public int MaxLengthTitle = 150;
        public int MaxLengthDescription = 300;
        ...
        public string ReplaceYear = "year";
        public string ReplaceName = "name";
        public string ReplaceAddress = "address";
        public string ReplacePhone = "phone";
        public string ReplaceEmail = "email";
        #endregion
