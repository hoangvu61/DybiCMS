namespace Web.FrontEnd.Modules
{
    ...
    public partial class ArticleCommentItem : VITModule
    {
        ...
        protected ItemLanguageModel dto;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            this.dto = CacheProvider.GetCache<ItemLanguageModel>(CacheProvider.Keys.Art, this.Config.Id, id, this.Config.Language);
            if (this.dto == null)
            {
                ...
                if (dto == null)
                {
                    ...
                    else dto = new ItemLanguageModel();
                }
                else
                {
