...
<div class="fb-like<%=Box?"-box" : "" %>" data-href="<%= YourUrl%>" data-width="<%= Skin.Width%>" data-show-faces="<%= ShowFaces%>" data-border-color="<%= BorderColor%>" data-stream="<%= Stream%>" data-header="<%= Header%>"></div>