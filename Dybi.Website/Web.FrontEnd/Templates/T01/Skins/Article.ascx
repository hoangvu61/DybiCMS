...
<section class="article_section">
    <div class="container">
        <%if (dto.Attributes.Any(a => a.Id == "Background")) {%>
        <style>
            .entry-header{background-image: url('<%= HREF.DomainStore + dto.Attributes.FirstOrDefault(a => a.Id == "Background").Value%>') !important;}
        </style>
        <%}%> 
        <%if (DisplayTitle){ %>
...
<%if (HREF.CurrentComponent == "article")
    { %>
<section class="section-all mt-5">
    <div class="container">
