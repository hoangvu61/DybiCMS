...
<%if (this.Skin.HeaderBackgroundFile != null)
    {%>
<style>
    .entry-header {
        background-image: url('<%= HREF.DomainStore + Skin.HeaderBackgroundFile.FullPath%>') !important;
    }
</style>
<%}%>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control form-control-sm" name="infoValue1" />
                    </div>
                    <div class="form-group">
                        <label>Email</label>
                        <input class="form-control form-control-sm" name="infoValue0" />
                    </div>
                    <%--<div class="form-group">
                    <label>Công ty của bạn</label>
                    <input class="form-control form-control-sm" name="infoValue2"/>
                </div>--%>
                </div>
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <textarea rows="10" class="form-control" name="infoValue3"></textarea>
                    </div>
                </div>
            </div>
            <div class="form-group">
...
<input type="hidden" name="infoLable" value="Email|Công ty|Website|Nội dung" />
