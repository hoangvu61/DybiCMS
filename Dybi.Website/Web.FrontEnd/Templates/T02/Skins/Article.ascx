...
<section class="article_content">
    <div class="container">
        ...
        <h1 class="h-title" title="<%=dto.Title%>" style="margin:30px"><%=dto.Title%></h1>
        <%} %> 
        <strong><%=dto.Brief%></strong>
        <%if (!string.IsNullOrEmpty(dto.ImageName) && this.GetValueParam<bool>("DisplayImage")){ %>
        <div class="article-img">
            <picture>
                ...
                <img class="article_image" src="<%=!string.IsNullOrEmpty(dto.ImageName) ? HREF.DomainStore + dto.Image.FullPath : "/templates/t02/img/no-image-available.png"%>" alt="<%=Title %>"/>
            </picture>
        </div>
        <%} %>
        <ul>
        ...
        <div class="my-3"><%=dto.Content.PageArticleLink()%></div>
