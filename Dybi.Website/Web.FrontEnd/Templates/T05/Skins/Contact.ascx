...
<section class="contact py-lg-4 py-md-3 py-sm-3 py-3" id="contact">
    <div class="container py-lg-5 py-md-4 py-sm-4 py-3">
        <h1 class="news_text mb-5" title="<%=Title %>"><%=Title %></h1>
        ...
        <div class="row">
            ...
            <div class="col-lg-6 col-md-6 contact-details">
                <VIT:Form ID="frmMain" runat="server" Enctype="multipart/form-data">
                <div class=" form-group contact-forms">
                    <%{txtName.Attributes.Add("placeholder", "Họ tên");} %>
                    <asp:TextBox ID="txtName" runat="server" CssClass="email-bt" required="required"></asp:TextBox>
                </div>
                <div class="form-group contact-forms">
                    <%{txtPhone.Attributes.Add("placeholder", "Số điện thoại");} %>
                    <asp:TextBox ID="txtPhone" runat="server" CssClass="email-bt" required="required"></asp:TextBox>
                </div>
                <div class="form-group contact-forms">
                ...
                <div class="form-group contact-forms">
                    <input type="text" name="infoValue0" class="email-bt" placeholder="Số lượng"/>
                </div>
                <div class="form-group contact-forms">
                    <input type="text" name="infoValue1" class="email-bt" placeholder="Giá mong muốn"/>
                </div>
                <div class="form-group contact-forms">
                    <textarea type="text" rows="5" name="infoValue2" class="massage-bt" placeholder="Mô tả mẫu"></textarea>
                </div>
                <div class="form-group contact-forms">
