<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="../../../Modules/MediaOthers.ascx.cs" Inherits="Web.FrontEnd.Modules.MediaOthers" %>
...
<script type="application/ld+json">
{
    ...
    "itemListElement": [
        ...
        <%= i > 0 ? "," : "" %>
        {
            ...
            <%} %>
            "url": "<%=HREF.LinkComponent("Video",Data[i].Title.ConvertToUnSign(), true, "smid", Data[i].Id )%>"
        }
        <%} %>
    ]
}
