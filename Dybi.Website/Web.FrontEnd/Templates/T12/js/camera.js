...
//		}
	...
	function nextSlide(navSlide){ 
		...
		if(!$('.imgLoaded',slide).length){
			...
			slide.prepend($(imgLoaded).attr('class', 'imgLoaded').attr('alt', 'Khanh Tam').css('visibility', 'hidden'));
			var wT, hT;
			...
			if( allImg.length > (slideI+1) && !$('.imgLoaded',slideNext).length ){
				...
				slideNext.prepend($(imgLoaded2).attr('class', 'imgLoaded').attr('alt', 'Khanh Tam').css('visibility','hidden'));
