        ...
        <div class="row">
                ...
                <div class="addons">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr scope="row">
                                <td colspan="2">
                                    <a class="image img-scaledown" href="<%=HREF.LinkComponent(HREF.CurrentComponent,r.Title.ConvertToUnSign(), true, SettingsManager.Constants.SendProduct, r.Id)%>" title="<%=r.Title%>">
                                        <picture>
                                ...
                                <td>
                                    <a target="_blank" class="addon_title" href="<%=HREF.LinkComponent(HREF.CurrentComponent,r.Title.ConvertToUnSign(), true, SettingsManager.Constants.SendProduct, r.Id)%>" title="<%=r.Title%>">
            ...
            <div class="col-12 col-md-<%= AddOns.Count == 0 ? "12" : "6"%> mx-auto">
                <div class="relatied">
                    ...
                    <div class="col-6 col-md-<%= AddOns.Count == 0 ? "2" : "3"%> text-center">
                        <a class="image img-scaledown" href="<%=HREF.LinkComponent(HREF.CurrentComponent,r.Title.ConvertToUnSign(), r.Id, SettingsManager.Constants.SendProduct, r.Id)%>" title="<%=r.Title%>">
                            <picture>
						      <source srcset="<%=HREF.DomainStore + r.Image.FullPath%>.webp" type="image/webp">
						      <source srcset="<%=HREF.DomainStore + r.Image.FullPath%>" type="image/jpeg"> 
