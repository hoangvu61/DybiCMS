...
<section class="product_section layout_padding">
         <div class="container">
            <div class="row">
        <div class="col-12 col-md-6 col-lg-<%=Attributes.Count > 0?4:6 %> mx-auto">
            <div class="img-box">
          ...
          <div class="col-6 col-md-6 col-lg-<%=Attributes.Count > 0?4:6 %> mx-auto">
              <div class="box">
...
<script>
    ...
    //    $('.img-box #slider').height($('.img-box #slider').width());
    //    $('.img-box #slider').css("overflow", "hidden");
    //});
</script>
