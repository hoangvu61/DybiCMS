                ...
                <div class="container ">
                    <div class="row">
                        <div class="col-md-6 ">
                            ...
                            <div class="btn-box">
                                <a class="btn1" href="<%=HREF.LinkComponent(Category.ComponentDetail, Data[i].Title.ConvertToUnSign(), Data[i].Id, SettingsManager.Constants.SendArticle, Data[i].Id)%>" class="btn1">
                                    Xem chi tiết
                                </a>
                            </div>
                            </div>
