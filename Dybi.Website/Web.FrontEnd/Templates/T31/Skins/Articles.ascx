...
<section class="articles_section py-5" <%=!string.IsNullOrEmpty(Skin.HeaderBackground) ? "style='background:" + Skin.HeaderBackground + "'" : ""%>>
    <div class="container">
        ...
        <%}%>
        <div class="text-center" <%=!string.IsNullOrEmpty(Skin.HeaderFontColor) ? "style='color:" + Skin.HeaderFontColor + "'" : ""%>>
        ...
        <div class="row article-list py-5">
            ...
            <div class="col-<%=i == 0 ? 12 : 6 %> col-md-6 mx-auto py-3">
                <a href="<%=HREF.LinkComponent(Category.ComponentDetail, Data[i].Title.ConvertToUnSign(), true, SettingsManager.Constants.SendArticle, Data[i].Id)%>" title="<%=Data[i].Title%>">
                            ...
                            <div class="col-12 col-sm-12 col-lg-7">
                                <div class="articel-content py-2">
                                    ...
                                    <div class="blog-first-para" title="<%=Data[i].Brief.DeleteHTMLTag() %>">
                                        <%=Data[i].Brief.Length > 80 ? Data[i].Brief.Substring(0, 80).DeleteHTMLTag() + "..." : Data[i].Brief.DeleteHTMLTag() %>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="btn-box">
                <%if(HREF.CurrentComponent == "home") {%>
                    <a class="alm-btn-wrap" href="<%=HREF.LinkComponent(Category.ComponentList, Category.Title.ConvertToUnSign(), true, "scat", Category.Id)%>" title="<%=Category.Title %>">
                        <%=Language["viewall"] %>
                    </a>
                <%} else {%>
