...
<section class="customer_section layout_padding">
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination">
            ...
            <li><a href="<%=HREF.CurrentURL %>">1</a></li>
            <li><a href="<%=HREF.CurrentURL %>">2</a></li>
            <li><a href="<%=HREF.CurrentURL %>">3</a></li>
            <li><a href="<%=HREF.CurrentURL %>">4</a></li>
            <li><a href="<%=HREF.CurrentURL %>">5</a></li>
            <li><a href="#">...</a></li>
            <li><a href="<%=HREF.CurrentURL %>">92</a></li>
            <li><a href="<%=HREF.CurrentURL %>">93</a></li>
            <li><a href="<%=HREF.CurrentURL %>">94</a></li>
            <li><a href="<%=HREF.CurrentURL %>">95</a></li>
            <li><a href="<%=HREF.CurrentURL %>">96</a></li>
            <li>
