...
namespace Web.Api.Migrations
{
    ...
    [Migration("20240805033921_8.22.19")]
    partial class _82219
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromFactory", b =>
                {
                    ...
                    b.HasKey("WarehouseInputId", "FactoryId");
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromOrder", b =>
                {
                    ...
                    b.HasKey("WarehouseInputId", "OrderId");

                    b.HasIndex("OrderId");

                    b.HasIndex("WarehouseInputId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromOrder", b =>
                {
                    ...
                    b.HasOne("Web.Api.Entities.WarehouseInput", "Input")
                        .WithOne("FromOrder")
                        .HasForeignKey("Web.Api.Entities.WarehouseInputFromOrder", "WarehouseInputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
