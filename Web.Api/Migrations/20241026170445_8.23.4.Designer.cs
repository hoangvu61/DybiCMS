...
namespace Web.Api.Migrations
{
    ...
    [Migration("20241026170445_8.23.4")]
    partial class _8234
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Web.Api.Entities.Company", b =>
                {
                    ...
                    b.Property<string>("TaxCodePlace")
                        .HasMaxLength(200)
            ...
            modelBuilder.Entity("Web.Api.Entities.OrderDebt", b =>
                {
                    ...
                    b.Property<DateTime?>("DebitExpire")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInput", b =>
                {
                    ...
                    b.Property<Guid?>("WarehouseFactoryId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("WarehouseId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("WarehouseSupplierId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("Id");

                    b.HasIndex("WarehouseFactoryId");
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromFactory", b =>
                {
                    ...
                    b.Property<string>("FactoryEmail")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseOutputProductCode", b =>
                {
                    ...
                    b.HasKey("OutputId", "ProductId", "ProductCode");
            ...
            modelBuilder.Entity("Web.Api.Entities.OrderDebt", b =>
                {
                    b.HasOne("Web.Api.Entities.Order", "Order")
                        .WithOne("Debt")
                        .HasForeignKey("Web.Api.Entities.OrderDebt", "OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInput", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseFactory", null)
                        .WithMany("Inputs")
                        .HasForeignKey("WarehouseFactoryId");
                    ...
                    b.HasOne("Web.Api.Entities.WarehouseSupplier", null)
                        .WithMany("Inputs")
                        .HasForeignKey("WarehouseSupplierId");
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputDebt", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseInput", "Input")
                        .WithOne("Debt")
                        .HasForeignKey("Web.Api.Entities.WarehouseInputDebt", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromFactory", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseFactory", "Factory")
                        .WithMany()
                    ...
                    b.HasOne("Web.Api.Entities.WarehouseInput", "WarehouseInput")
                        .WithOne("FromFactory")
                        .HasForeignKey("Web.Api.Entities.WarehouseInputFromFactory", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromOrder", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseInput", "Input")
                        .WithOne("FromOrder")
                        .HasForeignKey("Web.Api.Entities.WarehouseInputFromOrder", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromSupplier", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseInput", "WarehouseInput")
                        ...
                        .HasForeignKey("Web.Api.Entities.WarehouseInputFromSupplier", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputFromWarehouse", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseInput", "WarehouseInput")
                        ...
                        .HasForeignKey("Web.Api.Entities.WarehouseInputFromWarehouse", "InputId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseInputProductCode", b =>
                {
                    b.HasOne("Web.Api.Entities.WarehouseInputProduct", "InputProduct")
                        .WithMany("Codes")
            ...
            modelBuilder.Entity("Web.Api.Entities.WarehouseOutputProductCode", b =>
                {
                    ...
                    b.HasOne("Web.Api.Entities.WarehouseOutputProduct", "OutProduct")
                        .WithMany("Codes")
                    ...
                    b.HasOne("Web.Api.Entities.WarehouseInputProductCode", "ProductInputCode")
                        .WithOne("InputProductCode")
                        .HasForeignKey("Web.Api.Entities.WarehouseOutputProductCode", "InputId", "ProductId", "ProductCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Input");

                    b.Navigation("OutProduct");
